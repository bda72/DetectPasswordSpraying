...
A user could have a forgotten iPad sitting at home that occasioannly wakes up to check for new email. They change their password and 90 days later are forced to change their password again. Their account won't start locking out until they change their password a third time. But for those preceding 180 days, there will be a steady stream of logons failures. There could easily be dozens of users in that sceanrio at all times, filling your event logs.
